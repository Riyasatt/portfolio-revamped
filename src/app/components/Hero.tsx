  ...
  return (
    <main className={`${oswald.className}`}>
      <div className='relative  overflow-hidden '>
        <div className=' h-[115vh] mx-auto  bg-center bg-cover lg:bg-contain bg-repeat-x  opacity-30  ' />
        <div className='absolute top-[20%] w-full '>
          <div className='text-center  relative hero-text-removed  cursor-default font-extrabold text-[65px]  sm:text-[80px] md:text-[90px]  lg:text-[120px] xl:text-[136px] container  mx-auto   tracking-tighter leading-tight '>
            ...
            <span className='text-gradient relative animate-char-in-onReload' style={{animationDelay : "0s"}} >‘‘</span> <span className='animate-char-in-onReload relative' style={{animationDelay : "0.1s"}} >BUILDING</span> <span className=' text-gradient blur-2xl animate-char-in-onReload' style={{animationDelay : "0.2s"}} >WEBSITES</span> <span className='animate-char-in-onReload' style={{animationDelay : "0.3s"}} >THAT</span> <span className='animate-char-in-onReload' style={{animationDelay : "0.4s"}} >MAKES</span>  <span className=' text-gradient animate-char-in-onReload blur-2xl' style={{animationDelay : "0.5s"}} >PIXELS</span>  <span className='animate-char-in-onReload' style={{animationDelay : "0.6s"}} >DANCE</span> <span className='text-gradient animate-char-in-onReload' style={{animationDelay : "0.7s"}} >’’</span>
            </div>
            <div className='absolute left-0 ' >
            <span className='text-gradient animate-char-in-onReload' style={{animationDelay : "0s"}} >‘‘</span> <span className='animate-char-in-onReload' style={{animationDelay : "0.1s"}} >BUILDING</span> <span className=' text-gradient  animate-char-in-onReload' style={{animationDelay : "0.2s"}} >WEBSITES</span> <span className='animate-char-in-onReload' style={{animationDelay : "0.3s"}} >THAT</span> <span className='animate-char-in-onReload' style={{animationDelay : "0.4s"}} >MAKES</span>  <span className=' text-gradient animate-char-in-onReload ' style={{animationDelay : "0.5s"}} >PIXELS</span>  <span className='animate-char-in-onReload' style={{animationDelay : "0.6s"}} >DANCE</span> <span className='text-gradient animate-char-in-onReload' style={{animationDelay : "0.7s"}} >’’</span>
            </div>
          </div>
        </div>
